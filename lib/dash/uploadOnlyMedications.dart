...
class UploadOnlyMedications extends StatefulWidget {
  const UploadOnlyMedications({Key? key}) : super(key: key);

  @override
  State<UploadOnlyMedications> createState() => _UploadOnlyMedicationsState();
}

class _UploadOnlyMedicationsState extends State<UploadOnlyMedications> {
  ...
  uploadMedications() async {
    ...
    var appointmentID=DateTime.now().toUtc().millisecondsSinceEpoch;
    var doctorID=0;
    ...
    var response = await http.post(
      ...
      body: jsonEncode(<String, String>{
        "id": "${appointmentID}|${doctorID}|${userID.toString()}",
                              ...
                              Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: DropdownButtonFormField2(
                                    ...
                                    onChanged: (value) {
                                      selectedMedicineFoodRestrictions =value.toString();
                                      //Do something when changing the item if you want.
                                    },
                                    onSaved: (value) {},
                                  ),
